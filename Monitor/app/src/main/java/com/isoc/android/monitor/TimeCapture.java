...
public class TimeCapture {
    ...
    public static String getCurrentStringTime(){ return getTime(defaultTimeFormat,Calendar.getInstance().getTimeInMillis());}
    ...
    public static long getUpTime(){return (System.currentTimeMillis()-SystemClock.elapsedRealtime());}
    ...
    //uptime as a date
    public static String getUpDate(){return getGivenStringTime((System.currentTimeMillis()-SystemClock.elapsedRealtime()));}
}
